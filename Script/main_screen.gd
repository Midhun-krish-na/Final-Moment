...
#Connect Button Signals 
	$ButtonContainer/Start.connect("pressed", _on_start_pressed)
	$ButtonContainer/Continue.connect("pressed", _on_continue_pressed)
	$ButtonContainer/Setting.connect("pressed", _on_settings_pressed)
	$ButtonContainer/Credit.connect("pressed", _on_credits_pressed)
	$ButtonContainer/Quit.connect("pressed",_on_quit_pressed )
